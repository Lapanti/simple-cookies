(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["simple-cookies"] = factory();
	else
		root["simple-cookies"] = factory();
})(this, function() {
...
/* WEBPACK VAR INJECTION */(function(process) {class CookieError extends Error {
}
/* harmony export (immutable) */ __webpack_exports__["CookieError"] = CookieError;

const daysToMillis = 24 * 60 * 60 * 1000; // tslint:disable-line:no-magic-numbers
const checkCookieSupport = (opts) => {
...
const cookies = {
    ...
    set: write,
    remove: (name, opts) => write(name, '', Object.assign({ days: -1 }, opts)),
};
const priv = process && process.env && process.env.NODE_ENV === 'test' ? { checkCookieSupport } : null;
